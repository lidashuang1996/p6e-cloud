package club.p6e.cloud.websocket.controller.support.config;
...
public class ExceptionConfig extends BasicErrorController {
     ...
     */
    public ExceptionConfig(ServerProperties server) {
    ...
    public ModelAndView errorHtml(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            LOGGER.error("[EXCEPTION CONFIG]", e);
        }
        return null;
    }
}
